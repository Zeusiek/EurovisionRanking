...
public class MainPanel extends JPanel{
    MainPanel(){
        ...
        setBounds(0,0,MyFrame.DIMENSION.width,60);
        setLayout(null);
        ...
        categories.setBounds(-60,10,MyFrame.DIMENSION.width+100, 40);
        for (JLabel jLabel: jLabels){
            if(jLabel.getText().equals("Lp."))
                jLabel.setPreferredSize(new Dimension(25, 40));
            else jLabel.setPreferredSize(new Dimension(120, 40));
            jLabel.setFont(font);
